...
public class SonarFixer {
	 ...
	 * 
	 * TODO [FIND] "switch case" clauses should not have too many lines
	 * 
	 * [FIND] Unused private fields should be removed
	 * 
	 * [FIND] Strings literals should be placed on the left side when checking
	 * for equality
	 * 
	 * [FIND] Exception types should not be tested using "instanceof" in catch
	 * blocks
	 *
	 * 
...
//				"-o", "C:\\workspace\\SPOONED_NO_PROCESSORS\\log4j\\src\\main\\java", 
//				"--with-imports" };
...
//		 "-p",
//		 "iagl.opl.rendu.one.processors.OverrideProcessor", 
//		 "--source-classpath",
