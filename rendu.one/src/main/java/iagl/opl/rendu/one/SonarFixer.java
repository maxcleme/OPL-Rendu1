...
public class SonarFixer {
	...
	public static void main(String[] args) throws Exception {
		String[] spoonArgs = { "-i", "C:\\workspace\\OPL_Sample\\commons-lang\\src", "-p",
				"iagl.opl.rendu.one.processors.SwitchTooManyLinesProcessor", "-v", "--source-classpath",
				...
				"-o", "C:\\workspace\\SPOONED\\commons-lang\\src\\main\\java", "--with-imports" };
		// String[] spoonArgs = { "-i",
